...
const initValues: ICourse[] =[
  ...
  },
  {
    ...
    "Description": "Thống thạo các khái niệm nâng cao trong phát triển web bao gồm các framework và thư viện.",
    "ViewCount": 2200,
  ...
  },
  {
    ...
    "Description": "Khám phá những khái niệm cơ bản của trí tuệ nhân tạo và học máy.",
    "ViewCount": 3000,
  ...
  },
  {
    ...
    "Description": "Xây dựng ứng dụng di động đa nền tảng sử dụng framework React Native.",
    "ViewCount": 2500,
      ...
      <div className="wrapper">
        <div className="global-wrapper">
          <div className="content-left">
              ...
              {courses.map((course) => (
                <ImgMediaCard  key={course.ImgURL} course={course} />
              ))}
